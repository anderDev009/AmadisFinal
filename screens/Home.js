        ...
        <View className="flex-1 bg-gradient-to-b from-blue-500 to-purple-600">
            ...
            <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                <TouchableOpacity
                    ...
                    className="bg-green-600 p-4 rounded-lg mt-6 mx-auto shadow-lg w-60"
                >
                    <Text className="text-center text-white text-lg font-semibold">Acerca de</Text>
                </TouchableOpacity>

                {/* Botón de Videos */}
                <TouchableOpacity
                    onPress={() => navigation.navigate('Videos')}
                    className="bg-blue-500 p-4 rounded-lg mt-6 mx-auto shadow-lg w-60"
                >
                    <Text className="text-center text-white text-lg font-semibold">Videos</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
